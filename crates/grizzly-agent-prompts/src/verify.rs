...
pub enum VerifyError {
    ...
    MissingSourceFile {
        /// The prompt file declaring the stale entry.
        prompt: PathBuf,
        /// The prompt's id.
        id: String,
        /// The missing source file.
        file: String,
        /// The function the entry named.
        function: String,
    },
    ...
    FunctionNotInFile {
        ...
        /// The prompt's id.
        id: String,
        /// The source file that lacks the function.
        file: String,
        /// The function the entry named.
        function: String,
    },
