...
impl EditFile {
    ...
    pub fn spec() -> grizzly_agent_core::ToolSpec {
        grizzly_agent_core::ToolSpec {
            ...
            parameters: grizzly_agent_core::serde_json::json!({
                "type": "object",
                "properties": {
                    "path": {
                        "type": "string",
...
impl grizzly_agent_core::ToolDefinition for EditFile {
    type Params = EditFileParams;

    fn spec() -> grizzly_agent_core::ToolSpec {
        Self::spec()
    }
}
...
impl grizzly_agent_core::ToolDefinition for Ping {
    type Params = grizzly_agent_core::NoParams;
...
impl grizzly_agent_core::ToolDefinition for StartServer {
